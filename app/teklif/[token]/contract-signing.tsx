          ...
          >
            ...
            {!codeSent ? (
              ...
              <form onSubmit={handleVerifyCode} className="space-y-3">
                <div className="rounded-lg border border-emerald-500/20 bg-emerald-500/5 px-4 py-2.5 text-center text-xs text-emerald-400">
                  Dogrulama kodu gonderildi! Gelen kutunuzu kontrol edin.
                </div>
                <input
                  type="text"
                  required
