...
export default function ContractSigning({
  ...
  async function handleSendCode() {
    ...
    if (res.success) {
      ...
      setError(res.error || "Kod gonderilemedi");
    }
    setLoading(false);
  }
  ...
  async function handleVerifyCode(e: React.FormEvent) {
    ...
    if (res.success) {
      ...
      setError(res.error || "Dogrulama basarisiz");
    }
    setLoading(false);
  }
  ...
  async function handleSign() {
    ...
    try {
      ...
      if (data.success) {
        ...
        setError(data.error || "Imzalama basarisiz");
      }
    } catch {
  ...
  const steps = [
    ...
    { key: "verify", label: "Dogrulama", num: 2 },
    { key: "read", label: "Sozlesme", num: 3 },
    { key: "sign", label: "Imza", num: 4 },
  ];
    ...
    <div className="rounded-2xl border border-white/10 bg-white/[0.02] overflow-hidden">
      ...
      <div className="border-b border-white/5 px-6 py-4">
        ...
        <p className="mt-1 text-xs text-white/30">
          {firmName} projesi icin hizmet sozlesmesi
        </p>
      </div>
      ...
      <AnimatePresence mode="wait">
        ...
        {step === "info" && (
          ...
          >
              ...
              <>
                <div>
                  ...
                  <input
                    ...
                    className="w-full rounded-lg border border-white/10 bg-white/5 px-4 py-2.5 text-sm text-white placeholder-white/20 outline-none focus:border-[#FF4500]/30"
                    placeholder="Sirket Adi Ltd. Sti."
                  />
                </div>
            ...
            <div>
              <label className="block text-[10px] uppercase tracking-wider text-white/30 mb-1.5">
                E-posta * <span className="text-[#FF4500]/50">(dogrulama kodu gonderilecek)</span>
              </label>
              <input
                type="email"
                required
        ...
        {step === "verify" && (
          ...
          >
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-white/80">E-posta Dogrulayin</h3>
              <p className="mt-1 text-sm text-white/30">
                <span className="text-[#FF4500]/70">{signerEmail}</span> adresine 6 haneli dogrulama kodu gonderilecek.
              </p>
            </div>
              ...
              <div className="flex items-start gap-2">
                ...
                <div className="space-y-1.5">
                  <p className="text-xs text-amber-300/90 font-medium">
                    Dogrulama kodu e-postaniza gonderilecektir.
                  </p>
                  <p className="text-[11px] text-white/40 leading-relaxed">
                    Gelen kutunuzda mail goremiyorsaniz, lutfen
                    <span className="text-amber-400/80 font-semibold"> Onemsiz (Junk/Spam) </span>
                    klasorunu kontrol edin. Mail bu klasore dusmus olabilir.
                  </p>
                  <p className="text-[11px] text-white/40 leading-relaxed">
                    Onemsiz klasorunde buldugunuzda
                    <span className="text-emerald-400/80 font-semibold"> &quot;Onemsiz Degil&quot; </span>
                    olarak isaretleyin, boylece sonraki mailler gelen kutunuza ulasir.
                  </p>
                  <p className="text-[11px] text-white/30">
                    Kod 10 dakika gecerlidir. Sure dolarsa &quot;Tekrar gonder&quot; ile yeni kod alabilirsiniz.
                  </p>
                </div>
              </div>
            </div>
            ...
            {!codeSent ? (
              <button
                ...
                className="w-full rounded-xl bg-gradient-to-r from-[#FF4500] to-orange-600 px-6 py-3.5 text-sm font-semibold text-white shadow-lg shadow-[#FF4500]/20 transition-all hover:shadow-[#FF4500]/40 disabled:opacity-50"
              >
                {loading ? "Gonderiliyor..." : "Dogrulama Kodu Gonder"}
              </button>
            ) : (
              <form onSubmit={handleVerifyCode} className="space-y-3">
                <div className="rounded-lg border border-emerald-500/20 bg-emerald-500/5 px-4 py-3 text-center space-y-1">
                  ...
                  <div className="text-[11px] text-white/30">
                    Gelen kutunuzu veya Onemsiz/Spam klasorunuzu kontrol edin.
                  </div>
                </div>
                <input
                  type="text"
        ...
        {step === "read" && (
          ...
          >
            <div className="text-center">
              <h3 className="text-sm font-semibold text-white/60">Sozlesme Metni</h3>
              <p className="mt-1 text-[10px] text-white/20">
                Lutfen sozlesmeyi dikkatle okuyun ve asagiya kayarak devam edin.
              </p>
            </div>
        ...
        {step === "sign" && (
          ...
          >
            <div className="text-center">
              <h3 className="text-sm font-semibold text-white/60">Dijital Imza</h3>
              <p className="mt-1 text-[10px] text-white/20">
                Asagidaki alana parmaginizla veya mouse ile imzanizi atin.
              </p>
            </div>
            ...
            <label className="flex items-start gap-3 rounded-lg border border-white/5 bg-white/[0.02] p-3 cursor-pointer">
              ...
              <span className="text-xs text-white/40 leading-relaxed">
                Isbu sozlesmeyi okudum, anladim ve tum maddeleri kabul ediyorum.
                Imzalayan kisi olarak, temsil ettigim gercek veya tuzel kisilik adina
                islem yapma yetkisine sahip oldugumu beyan ederim.
              </span>
            </label>
            ...
            >
              {loading ? "Imzalaniyor..." : "Sozlesmeyi Imzala ve Gonder"}
            </button>

            <p className="text-center text-[9px] text-white/15">
              Imza aninda IP adresiniz, cihaz bilginiz ve zaman damgasi kaydedilecektir.
              Bu veriler HMK m. 193 uyarinca kesin delil olarak kabul edilir.
            </p>
          </motion.div>
        )}
        ...
        {step === "done" && (
          ...
          >
            ...
            <h3 className="text-xl font-bold text-emerald-400">Sozlesme Imzalandi!</h3>
            <p className="mt-2 text-sm text-white/40">
              Imzali sozlesme e-posta adresinize gonderilecektir.
              En kisa surede projenize baslanacaktir.
            </p>
